...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{paper-results/dgp/figures/fixedN21_alpha0p1_coverage_width_by_o.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{paper-results/dgp/figures/poisson_alpha0p1_coverage_width_by_o.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{paper-results/dgp/figures/fixedN21_3_alpha0p1_within_vs_no_within.pdf}
