...
\[
B_j=\gamma\Bigl(\sqrt{1-\xi^2}\,\varepsilon_j+\xi\frac{M_j-25}{5}\Bigr),\qquad 0\le\xi<1.
\]
...
\((U,M,\varepsilon,X)\) is reused across \(\xi\in\{0,0.25,0.50,0.75\}\).

All \(20{,}000\) GHCP intervals in the shipped run were finite.
...
Figures: `coverage_by_xi.pdf` (2×2 coverage with SE), `width_by_xi.pdf` (width
boxplots). Summary: `summary_by_xi_o.csv`.
