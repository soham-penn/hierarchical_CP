...
- Eligible groups: 165 (size ≥ 31)
- Total individuals in eligible groups: 10380
- PUMA size range: 31–252
- Subsample size m0: 31; subsample replicates B_sub: 200
...
- X summaries: median omnibus stat = 0.1635, median perm p = 0.0240, fraction p<0.05 = 0.710
- Residual summaries: median omnibus stat = 0.3121, median perm p = 0.0020, fraction p<0.05 = 1.000
...
|---|---:|---:|---:|
| entry_recency_mean | -0.218 | 0.0050 | 0.990 |
| english_mean | -0.134 | 0.0852 | 0.095 |
| age_sq_mean | -0.123 | 0.1147 | 0.150 |
| age_mean | -0.118 | 0.1298 | 0.115 |
| entry_recency_sd | 0.112 | 0.1519 | 0.200 |

### Residual summaries

| summary | median ρ | median p | frac p<0.05 |
|---|---:|---:|---:|
| resid_median | 0.283 | 0.0002 | 1.000 |
| resid_q75 | 0.279 | 0.0003 | 1.000 |
| resid_mean | 0.274 | 0.0004 | 1.000 |
| resid_q25 | 0.257 | 0.0008 | 0.995 |
| resid_sd | 0.100 | 0.2009 | 0.045 |
