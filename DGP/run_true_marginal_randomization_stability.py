...
from DGP.run_true_marginal_experiments import (
    BASE_SEED,
    alpha_to_tag,
    build_configs,
...
def main() -> None:
    ...
    for config_name in config_names:
        ...
        out_metrics = PROJECT_ROOT / "NEW_RESULTS" / f"true_marg_{config_name}_randomization_stability_dataset_metrics.csv"
        out_summary = PROJECT_ROOT / "NEW_RESULTS" / f"true_marg_{config_name}_randomization_stability_summary.csv"
