#!/usr/bin/env python3
"""Generate plots for alpha=0.2 results."""
...
# Override paths for alpha=0.2
BASE_DIR = script_path.parent.parent
plotter.RESULTS_FILE = BASE_DIR / "acs/results/true_marginal_alpha20/acs_true_marg_alpha20_detailed.csv"
plotter.OUTPUT_DIR = BASE_DIR / "acs/NEW_PLOTS/true_marginal_alpha20/paper_style"
plotter.SUMMARY_DIR = BASE_DIR / "acs/results/true_marginal_alpha20/summaries"
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("ACS TRUE MARGINAL COVERAGE - Paper Plots (ALPHA=0.2)")
    print("=" * 70)
